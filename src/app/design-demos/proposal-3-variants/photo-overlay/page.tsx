      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-t border-blue-200 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-[#1A1A1A]">Variante B: Photo + Overlay</div>
              <div className="text-sm text-[#6B6B6B]">
                ✅ Corporate chic • ✅ Photo professionnelle • ✅ Overlay gradient sombre • ✅ Contraste fort
              </div>
            </div>
          </div>
        </div>
