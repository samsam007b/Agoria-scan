    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-4">Variante B: Photo + Overlay</h1>
          <p className="text-lg text-[#6B6B6B] mb-8">
            Cette variante utilisera une photo professionnelle en arrière-plan avec un overlay gradient bleu pour un look corporate chic.
          </p>
          <div className="bg-blue-50 border-l-4 border-[#1C32FF] p-6 mb-8 text-left">
            <h3 className="font-bold text-[#1A1A1A] mb-3">Concept de design:</h3>
            <ul className="space-y-2 text-sm text-[#6B6B6B]">
              <li>• Photo business/tech en arrière-plan</li>
              <li>• Overlay gradient bleu foncé (80-90% opacité)</li>
              <li>• Hexagone sur fond semi-transparent</li>
              <li>• Contraste fort et professionnel</li>
            </ul>
          </div>
