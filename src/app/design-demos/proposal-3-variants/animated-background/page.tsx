...
export default function AnimatedBackgroundVariantPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-center min-h-[80vh]">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">Variante C en cours de développement</h2>
