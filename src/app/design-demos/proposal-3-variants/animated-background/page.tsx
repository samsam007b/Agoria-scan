    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="text-sm font-bold text-[#6B6B6B]">
            Variante C: Animated Background
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          {/* Côté gauche - Hexagone avec fond animé */}
          <div className="relative py-12 flex items-center justify-center lg:border-r-2 lg:border-gray-200 overflow-hidden bg-gradient-to-br from-[#1C32FF] via-[#4169E1] to-[#7B68EE]">
            {/* Vagues animées en SVG */}
            <svg
            ...
            >
              ...
              <motion.path
                ...
                animate={{
                  d: [
                    "M0,500 C360,400 720,600 1080,500 C1260,450 1350,550 1440,500 L1440,800 L0,800 Z",
                    "M0,500 C360,600 720,400 1080,500 C1260,550 1350,450 1440,500 L1440,800 L0,800 Z",
                    "M0,500 C360,400 720,600 1080,500 C1260,450 1350,550 1440,500 L1440,800 L0,800 Z"
                  ]
                }}
                transition={{
            ...
            <div className="relative text-center z-20">
              ...
              <motion.div
                className="inline-block p-8 backdrop-blur-xl bg-white/20 border-2 border-white/60 shadow-[0_0_40px_rgba(255,255,255,0.3)]"
      ...
      {/* Info banner */}
      <div className="bg-gradient-to-r from-orange-50 to-purple-50 border-t border-orange-200 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            <TrendingUp size={24} className="text-[#1C32FF]" />
            <div>
              <div className="font-bold text-[#1A1A1A]">Variante C: Animated Background</div>
              <div className="text-sm text-[#6B6B6B]">
                ✅ Audacieux et dynamique • ✅ Vagues SVG animées • ✅ Particules flottantes • ✅ Effet glow au hover
              </div>
            </div>
          </div>
        </div>
