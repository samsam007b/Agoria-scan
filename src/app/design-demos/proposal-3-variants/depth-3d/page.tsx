    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-4">Variante E: 3D / Depth Effect</h1>
          <p className="text-lg text-[#6B6B6B] mb-8">
            Cette variante utilisera des effets 3D subtils et de la perspective pour créer un look premium et moderne.
          </p>
          <div className="bg-purple-50 border-l-4 border-purple-500 p-6 mb-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-[#6B6B6B]">
              <li>• Fond avec dégradé radial (centre plus clair)</li>
              <li>• Hexagone avec effet 3D léger (ombres portées + elevation)</li>
              <li>• Perspective subtile sur l'hexagone</li>
              <li>• Animation de rotation douce au hover</li>
            </ul>
          </div>
