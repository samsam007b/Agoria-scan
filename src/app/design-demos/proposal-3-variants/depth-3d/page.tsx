    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          {/* Côté gauche - Hexagone avec effet 3D et profondeur */}
          <div
            className="relative py-12 flex items-center justify-center lg:border-r-2 lg:border-gray-200 overflow-hidden"
            style={{
              background: 'radial-gradient(circle at center, #E8E6FF 0%, #D0CBFF 30%, #B8B0FF 60%, #A098FF 100%)'
            }}
          >
            {/* Couches de profondeur en arrière-plan */}
            <motion.div
            ...
            >
              {/* Layer 1 - Plus éloigné */}
              <div
                className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full blur-3xl"
                style={{
                  background: 'radial-gradient(circle, rgba(28, 50, 255, 0.3) 0%, transparent 70%)',
                }}
              />
              {/* Layer 2 - Moyen */}
              <div
            ...
            {/* Grille perspective en arrière-plan */}
            <div className="absolute inset-0 opacity-10" style={{ perspective: '1000px' }}>
              <div
                className="absolute inset-0"
                style={{
                  backgroundImage: `
                    linear-gradient(0deg, transparent 24%, rgba(28, 50, 255, .5) 25%, rgba(28, 50, 255, .5) 26%, transparent 27%, transparent 74%, rgba(28, 50, 255, .5) 75%, rgba(28, 50, 255, .5) 76%, transparent 77%, transparent),
                    linear-gradient(90deg, transparent 24%, rgba(28, 50, 255, .5) 25%, rgba(28, 50, 255, .5) 26%, transparent 27%, transparent 74%, rgba(28, 50, 255, .5) 75%, rgba(28, 50, 255, .5) 76%, transparent 77%, transparent)
                  `,
            ...
            <div className="relative text-center z-10" style={{ perspective: '1200px' }}>
              {/* Container avec effet 3D et ombres multiples */}
              <motion.div
                className="inline-block p-8 bg-white border border-gray-100"
                style={{
                  boxShadow: `
                    0 1px 2px rgba(0, 0, 0, 0.05),
                    0 4px 8px rgba(28, 50, 255, 0.1),
                    0 12px 24px rgba(28, 50, 255, 0.15),
                    0 24px 48px rgba(28, 50, 255, 0.2)
                  `,
                ...
                whileHover={{
                  ...
                  boxShadow: `
                    ...
                    0 8px 16px rgba(28, 50, 255, 0.12),
                    0 16px 32px rgba(28, 50, 255, 0.18),
                    0 32px 64px rgba(28, 50, 255, 0.25)
                  `,
                  transition: { duration: 0.3 }
                }}
              >
                {/* Couche intérieure pour effet de profondeur */}
                <div
                  className="absolute inset-0 -z-10"
                  style={{
                    background: 'linear-gradient(135deg, rgba(28, 50, 255, 0.05) 0%, rgba(123, 104, 238, 0.05) 100%)',
                ...
                <motion.h2
                  ...
                  style={{
                    transform: 'translateZ(20px)',
                    textShadow: '0 2px 8px rgba(28, 50, 255, 0.15)',
                  }}
                >
                  Découvrez les enjeux
                </motion.h2>
                <motion.p
                  className="text-sm text-[#6B6B6B] mb-8"
                  style={{
      ...
      {/* Info banner */}
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-t border-purple-200 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            <TrendingUp size={24} className="text-[#1C32FF]" />
            <div>
              <div className="font-bold text-[#1A1A1A]">Variante E: 3D / Depth Effect</div>
              <div className="text-sm text-[#6B6B6B]">
                ✅ Premium et sophistiqué • ✅ Ombres multiples • ✅ Perspective 3D • ✅ Rotation au hover
              </div>
            </div>
          </div>
        </div>
