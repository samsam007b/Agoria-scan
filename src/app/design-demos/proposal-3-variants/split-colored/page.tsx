    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-3xl font-bold text-[#1A1A1A] mb-4">Variante D: Split coloré</h1>
          <p className="text-lg text-[#6B6B6B] mb-8">
            Cette variante utilisera un fond bleu Agoria audacieux avec un hexagone blanc inversé pour un contraste maximal.
          </p>
          <div className="bg-pink-50 border-l-4 border-pink-500 p-6 mb-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-[#6B6B6B]">
              <li>• Fond bleu Agoria (#1C32FF) full</li>
              <li>• Hexagone en blanc avec bordures bleues inversées</li>
              <li>• Motifs géométriques blancs en arrière-plan</li>
              <li>• Contraste fort et énergique</li>
            </ul>
          </div>
